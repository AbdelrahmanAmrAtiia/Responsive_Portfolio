...
@section('content')
    ...
    <form action="{{ route('about.store') }}" method="POST" enctype="multipart/form-data"> 
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="number_projects" name="number_projects">
        </div>

        <div class="mb-3">
            <label for="number_companies" class="form-label">Number of Companies</label>
            <input type="text" class="form-control" id="number_companies" name="number_companies">
        </div>
